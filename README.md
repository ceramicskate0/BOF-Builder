...
- My fav error ` 1 | #include <Windows.h>` for a linux compile target LMFAO these people literally used the wrong import. Change to all lowercase. I rest my case for statement above.
